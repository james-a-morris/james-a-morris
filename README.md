...
- Focused on minimizing failure modes across UX, execution, and protocol design
...
- Security-first production engineering

---

## Background

I combine a strong formal background in **computer science and quantitative finance** with hands-on experience shipping systems that operate under real economic load.

My work sits at the intersection of:
- Protocol engineering
- Quantitative finance
- Execution reliability
- User-facing financial infrastructure
...
Always happy to connect or talk protocols, execution systems, and real-world DeFi.
